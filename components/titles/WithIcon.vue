<template>
    <div class="space-x-2 mt-2 mb-3">
        <div v-show="icon" class="inline-block">
            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" width="20" height="18">
                <path
        ...
        <div class="inline-block">
            <label :class="[size, classesText]"> {{ label }} </label>
        </div>
    </div>
</template>
